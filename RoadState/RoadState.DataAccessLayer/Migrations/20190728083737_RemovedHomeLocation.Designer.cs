...
namespace RoadState.DataAccessLayer.Migrations
{
    ...
    [Migration("20190728083737_RemovedHomeLocation")]
    partial class RemovedHomeLocation
    {
            ...
            modelBuilder.Entity("RoadState.Data.BugReport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishDate = new DateTime(2019, 7, 28, 11, 37, 37, 53, DateTimeKind.Local).AddTicks(2026),
                            Rating = 1,
                            State = "Low"
                        });
                });
            ...
            modelBuilder.Entity("RoadState.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "abcd",
                            Email = "123@gmail.com",
                            RegistrationDate = new DateTime(2019, 7, 28, 11, 37, 37, 55, DateTimeKind.Local).AddTicks(3618),
                            UserName = "dimasik"
                        });
                });
